...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ApiKeyInfo> result = apiInstance.apiKeysGet();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      CreateApiKeyResponse result = apiInstance.apiKeysIdRotatePost(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiKeysApi#apiKeysIdRotatePost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ApiKeysApi apiInstance = new ApiKeysApi(defaultClient);
    try {
      CreateApiKeyResponse result = apiInstance.apiKeysPost();
      System.out.println(result);
    } catch (ApiException e) {
