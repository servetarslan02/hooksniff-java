...
import org.openapitools.client.api.SimulatorApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SimulatorPostRequest simulatorPostRequest = new SimulatorPostRequest(); // SimulatorPostRequest | 
    try {
      apiInstance.simulatorPost(simulatorPostRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling SimulatorApi#simulatorPost");
