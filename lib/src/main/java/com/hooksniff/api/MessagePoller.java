...
public class MessagePoller {
    ...
    public List<PollingEndpointMessageOut> poll() throws IOException, ApiException {
        HttpUrl.Builder url = this.client.newUrlBuilder().encodedPath("/api/v1/message-poller/poll");
    ...
    public PollingEndpointConsumerSeekOut seek(PollingEndpointConsumerSeekIn body) throws IOException, ApiException {
        HttpUrl.Builder url = this.client.newUrlBuilder().encodedPath("/api/v1/message-poller/seek");
    ...
    public void commit() throws IOException, ApiException {
        HttpUrl.Builder url = this.client.newUrlBuilder().encodedPath("/api/v1/message-poller/commit");
