...
/**
 * Model tests for InviteMemberRequest
 */
public class InviteMemberRequestTest {
    private final InviteMemberRequest model = new InviteMemberRequest();
