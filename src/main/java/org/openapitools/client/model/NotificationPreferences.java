...
public class NotificationPreferences {
  ...
  public NotificationPreferences slackWebhookUrl(@javax.annotation.Nullable String slackWebhookUrl) {
  ...
  public NotificationPreferences discordWebhookUrl(@javax.annotation.Nullable String discordWebhookUrl) {
  ...
  public NotificationPreferences webhookUrl(@javax.annotation.Nullable String webhookUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emailOnFailure, notificationPreferences.emailOnFailure) &&
        Objects.equals(this.emailOnDeadLetter, notificationPreferences.emailOnDeadLetter) &&
        Objects.equals(this.emailOnSuccess, notificationPreferences.emailOnSuccess) &&
        Objects.equals(this.slackWebhookUrl, notificationPreferences.slackWebhookUrl) &&
        Objects.equals(this.discordWebhookUrl, notificationPreferences.discordWebhookUrl) &&
        Objects.equals(this.webhookUrl, notificationPreferences.webhookUrl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NotificationPreferences is not found in the empty JSON string", NotificationPreferences.openapiRequiredFields.toString()));
        }
      }
