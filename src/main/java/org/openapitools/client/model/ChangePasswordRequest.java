...
public class ChangePasswordRequest {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("current_password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `current_password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("current_password").toString()));
      }
