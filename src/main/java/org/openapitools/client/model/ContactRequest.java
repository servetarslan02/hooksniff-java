...
public class ContactRequest {
  ...
  public ContactRequest email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public ContactRequest subject(@javax.annotation.Nonnull String subject) {
  ...
  public ContactRequest message(@javax.annotation.Nonnull String message) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "email", "subject", "message"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "email", "subject", "message"));
  }
