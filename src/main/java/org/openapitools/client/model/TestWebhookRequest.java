...
public class TestWebhookRequest {
  ...
  public TestWebhookRequest endpointId(@javax.annotation.Nonnull UUID endpointId) {
  ...
  public TestWebhookRequest payload(@javax.annotation.Nonnull Object payload) {
  ...
  public TestWebhookRequest event(@javax.annotation.Nullable String event) {
    this.event = event;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpointId, testWebhookRequest.endpointId) &&
        Objects.equals(this.payload, testWebhookRequest.payload) &&
        Objects.equals(this.event, testWebhookRequest.event);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpointId, payload, event);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("endpoint_id", "payload", "event"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestWebhookRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestWebhookRequest is not found in the empty JSON string", TestWebhookRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestWebhookRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TestWebhookRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestWebhookRequest.openapiRequiredFields) {
