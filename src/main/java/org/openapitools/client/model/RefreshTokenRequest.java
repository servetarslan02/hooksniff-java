...
public class RefreshTokenRequest {
  ...
  public RefreshTokenRequest refreshToken(@javax.annotation.Nonnull String refreshToken) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RefreshTokenRequest is not found in the empty JSON string", RefreshTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RefreshTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
