...
public class CancelSubscriptionResponse {
  ...
  public CancelSubscriptionResponse cancelledAt(@javax.annotation.Nonnull OffsetDateTime cancelledAt) {
  ...
  public void setCancelledAt(@javax.annotation.Nonnull OffsetDateTime cancelledAt) {
    this.cancelledAt = cancelledAt;
  }


  public CancelSubscriptionResponse endsAt(@javax.annotation.Nonnull OffsetDateTime endsAt) {
    this.endsAt = endsAt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cancelledAt, cancelSubscriptionResponse.cancelledAt) &&
        Objects.equals(this.endsAt, cancelSubscriptionResponse.endsAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cancelledAt, endsAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cancelled_at", "ends_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("cancelled_at", "ends_at"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelSubscriptionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelSubscriptionResponse is not found in the empty JSON string", CancelSubscriptionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelSubscriptionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelSubscriptionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelSubscriptionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CancelSubscriptionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelSubscriptionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelSubscriptionResponse>() {
           @Override
