...
public class ApiKeyInfo {
  ...
  public ApiKeyInfo lastUsedAt(@javax.annotation.Nullable String lastUsedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, apiKeyInfo.id) &&
        Objects.equals(this.prefix, apiKeyInfo.prefix) &&
        Objects.equals(this.createdAt, apiKeyInfo.createdAt) &&
        Objects.equals(this.lastUsedAt, apiKeyInfo.lastUsedAt) &&
        Objects.equals(this.isActive, apiKeyInfo.isActive);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, prefix, createdAt, lastUsedAt, isActive);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiKeyInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApiKeyInfo is not found in the empty JSON string", ApiKeyInfo.openapiRequiredFields.toString()));
        }
      }
