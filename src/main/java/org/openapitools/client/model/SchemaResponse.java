...
public class SchemaResponse {
  ...
  public static final String SERIALIZED_NAME_SCHEMA_JSON = "schema_json";
  @SerializedName(SERIALIZED_NAME_SCHEMA_JSON)
  @javax.annotation.Nonnull
  ...
  public SchemaResponse id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SchemaResponse name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public SchemaResponse version(@javax.annotation.Nonnull Integer version) {
  ...
  public SchemaResponse schemaJson(@javax.annotation.Nonnull Object schemaJson) {
  ...
  public void setSchemaJson(@javax.annotation.Nonnull Object schemaJson) {
    this.schemaJson = schemaJson;
  }


  public SchemaResponse createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, schemaResponse.id) &&
        ...
        Objects.equals(this.version, schemaResponse.version) &&
        Objects.equals(this.schemaJson, schemaResponse.schemaJson) &&
        Objects.equals(this.createdAt, schemaResponse.createdAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, version, schemaJson, createdAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "version", "schema_json", "created_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "version", "schema_json", "created_at"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchemaResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SchemaResponse is not found in the empty JSON string", SchemaResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SchemaResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SchemaResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
