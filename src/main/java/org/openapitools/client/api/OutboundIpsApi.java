...
public class OutboundIpsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OutboundIpsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public OutboundIpsApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call outboundIpsGetCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/outbound-ips";
    ...
    private okhttp3.Call outboundIpsGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return outboundIpsGetCall(_callback);
    ...
    /**
     * Get outbound IP addresses for firewall whitelisting (asynchronously)
     * 
